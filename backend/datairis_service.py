...
class DataIrisService:
    ...
    def search(self, first_name: str, last_name: str, zip_code: str, 
        ...
        """
        Complete search workflow: authenticate, set criteria, and get results
        ...
        # Step 4: Get records
        return self.get_records(start, end)
    ...
    def parse_results(self, results: Dict) -> List[Dict]:
        ...
        if not results or "searchResultRecord" not in results:
            return parsed_records
        
        for record in results["searchResultRecord"]:
            parsed_record = {}

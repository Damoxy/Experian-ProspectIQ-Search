    ...
    "DonorInfo": {
        "DonationCategories": {
            "Donor_Charitable_Flag": {
                "label": "Charitable Donor",
                "type": "boolean",
                "transformer": lambda x: x == "1" if x else False,
            },
            "Donor_Religious_Flag": {
                "label": "Religious Donor",
                "type": "boolean",
                "transformer": lambda x: x == "1" if x else False,
            },
            "Donor_Political_Flag": {
                "label": "Political Donor",
                "type": "boolean",
                "transformer": lambda x: x == "1" if x else False,
            },
            "Donor_Environmental_Wildlife_Flag": {
                "label": "Environmental/Wildlife Donor",
                "type": "boolean",
                "transformer": lambda x: x == "1" if x else False,
            },
            "Donor_Health_Flag": {
            ...
            "Donor_International_Aid_Flag": {
                "label": "International Aid Donor",
                "type": "boolean",
                "transformer": lambda x: x == "1" if x else False,
            },
            "Donor_Childrens_Flag": {
                "label": "Children's Donor",
                "type": "boolean",
                "transformer": lambda x: x == "1" if x else False,
            },
            "Donor_Veterans_Flag": {
                "label": "Veterans Donor",
                "type": "boolean",
                "transformer": lambda x: x == "1" if x else False,
            },
            "Donor_Arts_Cultural_Flag": {
                "label": "Arts/Cultural Donor",
                "type": "boolean",
                "transformer": lambda x: x == "1" if x else False,
            },
        },
    ...
    for category, subcategories in DATAIRIS_UI_MAPPING.items():
        for sub_category, fields in subcategories.items():
            if field_id in fields:
                ...
                if field_config.get("transformer") and field_value:
                    try:
